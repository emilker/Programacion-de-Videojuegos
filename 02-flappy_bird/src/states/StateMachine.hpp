...
public:
    ...
    void change_state(const std::string& state_name, std::shared_ptr<World> world = nullptr, std::shared_ptr<Bird> bird = nullptr, bool pause = false, bool timer_powerup = false, int score = 0, float _time = 20.f) noexcept;
